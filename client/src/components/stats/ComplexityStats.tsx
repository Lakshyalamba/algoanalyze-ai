...
export function ComplexityStats({
  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <h2 className="text-base font-semibold text-slate-950">Common complexities</h2>
    ...
    <div>
      ...
      <div className="mt-3 space-y-2">
        {items.map((item) => (
          ...
          >
            <span className="font-mono text-sm font-semibold text-slate-950">{item.value}</span>
